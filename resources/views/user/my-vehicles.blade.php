                    ...
                    <h4 class="modal-title">
                        <div class="panel-heading no-padding">
                            <h4 class="panel-title">
                                <select class="selectpicker col-xs-2 no-padding" name="type">
                ...
                <div class="modal-body">
                    <div class="row no-padding address_row">
                        <div class="col-xs-6">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="from_address" placeholder="Street Address"/>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="from_city" placeholder="City"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="to_address" placeholder="Street Address"/>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="to_city" placeholder="City"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="panel-body col-xs-12">
                                            ...
                                            <div class="row next-row">
                                                <div class="col-xs-12 time_content">
                                                    ...
                                                    <div class="col-xs-2 input-small-field">
                                                        <input class="form-control" type="number" name="max_speed" id="select-max-speed" step="10" min="0" value="80">
                                                    </div>
                            ...
                            <div class="tab-pane transports" id="v_description-tab">
                                <div class="col-xs-12 no-padding">
                                    ...
                                    <div class="tabpanel col-xs-12">
                                        <div class="panel-body col-xs-12">
                                            <textarea class="form-control" rows="4" name="notes" placeholder="Vehicle Description for other users"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="tabpanel col-xs-12">
                                        <div class="panel-body col-xs-12">
                                            <div class="col-xs-2 col-xs-offset-2">
                                                <input class="form-control" type="number" name="cost_eur_km" placeholder="10" min="0">
                                            </div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-2 col-xs-offset-1">
                                                <input class="form-control" type="number" name="cost_eur_h" placeholder="10" min="0">
                                            </div>
                                            <div class="col-xs-2">
                    ...
                    <div class="row action_row">
                        <div class="col-xs-4 col-xs-offset-2">
                            <button type="button" class="btn btn-primary btn-block center-block find_route submit">SAVE</button>
                        </div>
                        <div class="col-xs-4">
