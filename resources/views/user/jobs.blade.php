        ...
        <form role="form" method="POST" action="{{ url('/optimize-problem') }}">
            <fieldset>
                ...
                <div class="row buttons">
                    <div class="col-xs-12">
                        <div class="form-group">
                            <button id="job-cancel" class="btn btn-danger pull-left" type="button" onclick="restoreTransjobsTab()">Cancel</button>
                            <button id="job-clear" class="btn btn-warning pull-left" type="button" onclick="clearTransjobsForm()">Clear</button>
