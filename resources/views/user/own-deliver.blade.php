<div id="own_delivery_form" class="transport_form">
    ...
    <div class="panel-default datepicker">
        ...
        <div id="find_job_accordion" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="job-date-heading">
            <input class="job_datepicker" type="text" name="find_job_date">
        </div>
    </div>

    <div class="row">
        <div class="col-xs-4 col-xs-offset-4 new-job">
            <button type="button" class="btn btn-primary btn-block center-block">FIND ROUTE</button>
        </div>
    </div>
<!--     <div class="panel-default">
        <button class="btn btn-success pull-left" type="button" onclick="">FIND ROUTE</button>
    </div>
 --></div>